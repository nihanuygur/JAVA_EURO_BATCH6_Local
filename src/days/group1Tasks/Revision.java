...
// other variable types to store numbers: byte, short, long, float, double. These can store different length of numbers.
...
// The following loop will ask the user for their name until they enter a valid name.
...
What does this program do?
	...
	1.5. Finds how many vowels are in your name with a nested loops and arrays of vowels.
		 Then replaces the vowels in your name with the same capital char to highlight them.
